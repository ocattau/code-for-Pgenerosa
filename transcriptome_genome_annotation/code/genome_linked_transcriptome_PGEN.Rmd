...
# Convert list elements to appropriate data types
gonad_genes_clean <- lapply(gonad_genes4, function(x) {
  if (is.list(x)) {
    unlist(x)
  } else {
    x
...
gonad_genes_df <- as.data.frame(gonad_genes_clean)

# Save as TSV file
write.table(gonad_genes_df, file = "/Users/oliviacattau/Documents/GitHub/olivia-geoduck/output/tables/reproductive_genes.tsv", sep = "\t", quote = FALSE, row.names = FALSE)


# Save the data frame as a TSV file
write.table(gonad_genes4, file = "/Users/oliviacattau/Documents/GitHub/olivia-geoduck/output/tables/reproductive_genes.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
