...
-in /gscratch/srlab/ocattau/clamdata/philli_ncbi_transcriptoms.fasta \
-dbtype nucl \
-out /gscratch/srlab/ocattau/clamdata/blastdb2/philli_db
...
-db /gscratch/srlab/ocattau/clamdata/blastdb2/philli_db \
-out /gscratch/srlab/ocattau/clamdata/blast_output/Pgenerosa_Manilla_db_blastx.tab \
-evalue 1E-20 \
-num_threads 30 \
-max_target_seqs 1 \
-max_hsps 1 \
