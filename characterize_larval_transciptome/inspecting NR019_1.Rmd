...
```{r}
countMatrix<-read.table(file="https://gannet.fish.washington.edu/gigas/analyses/juv-Trueseq-stranded-mRNA-libraries-NR019/abundance.tsv", header=TRUE)
head(countMatrix)
```
...
write.csv(identifiers_only, file="/Users/oliviacattau/Documents/analysis/code/pgenerosa/Pgenerosa/NR019_1.csv")
```
...
write.table(pgenerosa_scrubbed, file="/Users/oliviacattau/Documents/GitHub/code/pgenerosa_NR019_1.tab")
```
#push to Gannet
```{r} 
#use command line for this step
rsync -avP /Users/oliviacattau/Documents/GitHub/code/pgenerosa_NR019_1.tab ocattau@gannet.fish.washington.edu:/volume2/web/gigas/data/p.generosa/
```
