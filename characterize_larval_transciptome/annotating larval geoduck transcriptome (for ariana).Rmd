...
#make upset plot, not working right now, need to debug code
...
set_size(m1)
p1<-UpSet(m1 [comb_degree(m1)<=2], column_title = ="name") #intersections 2 or less
p2<-UpSet(m1 [comb_degree(m1)>=3]) #intersections 3 or more
