...
m3=make_comb_mat(heart=tidy_data$heart, gonad=tidy_data$gonad, ctenidia=tidy_data$ctenidia, juv_amb=tidy_data$juv_amb, juv_sl=tidy_data$juv_sl, larvae=tidy_data$larvae, mode="union") #union mode, degree 6 should be the entire data set (1.3M reads), (code can take a few minutes)
m4=make_comb_mat(heart=tidy_data$h, gonad=tidy_data$g, ctenidia=tidy_data$c, larvae=tidy_data$l, juv_amb=tidy_data$ja, juv_sl=tidy_data$jsl)
set_size(m1)
comb_size(m1)
comb_size(m2)
comb_size(m3) 
